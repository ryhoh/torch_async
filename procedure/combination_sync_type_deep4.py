...
MODEL_NAME = "{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_combination_sync_type_deep4".format(
...
def main():
    ...
    model = vgg16(num_classes=10, model_type=ARGS.convolution, pooling=ARGS.pooling,
                  ...
                  third_async=ARGS.third_async, fourth_async=ARGS.fourth_async,
                  bnflag=ARGS.bnflag).to(DEVICE)
