...
if not args.debug:
    model_name = "{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_imagenet{}".format(
...
def main():
    ...
    TRAIN_CSV = "imagenet_train_{}.csv".format(args.classnum)
    VAL_CSV = "imagenet_val_{}.csv".format(args.classnum)
    A_CSV = "imagenet_a_{}".format(args.classnum)
    ...
    if args.convolution == 'resnet':
        model = resnet(
            ...
            sync=args.fc,
            middleshape=args.ms,
            num_classes=args.classnum).to(device)
    ...
    # Dataset
    train_loader, val_loader, a_loader = preprocess.imagenet_n_dataloaders(
        root_dir=ROOT_DIR,
