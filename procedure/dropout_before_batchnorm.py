...
from models.dropout_before_batchnorm_vgg16 import Dropout_before_batchnorm_vgg16 as vgg16
...
MODEL_NAME = "{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_dropout_before_batchnorm".format(
...
def main():
    ...
    model = vgg16(num_classes=10, model_type=ARGS.convolution, pooling=ARGS.pooling,
                  ...
                  fc_do_flag=ARGS.fc_do_flag).to(DEVICE)
