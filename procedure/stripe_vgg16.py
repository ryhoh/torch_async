...
from models.stripe_semi_vgg16 import Stripe_semi_VGG16 as vgg16
...
parser.add_argument('--syncpattern', choices=['first', 'second'],
                    help='sync order', required=True)
parser.add_argument('--bnflag', action='store_true', help='flag for bn')

args = parser.parse_args()

now = datetime.datetime.now()
MODEL_NAME = "{}_{}_{}_{}_{}_{}_hori_modif_stripevgg16".format(
...
if __name__ == '__main__':
    ...
    model = vgg16(
        ...
        syncpattern=args.syncpattern, bnflag=args.bnflag
    )
