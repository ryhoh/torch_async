...
class Independent_Linear(Linear):
    """独立のLinear
    独立更新のレイヤー
    """
    ...
    def forward(self, input):
        res = Independent_WeightBias_Rate_LinearFunction.apply(
            input, self.weight, self.bias, self.rate)
        return res
...
if __name__ == "__main__":
    ...
    MODEL_NAME = "{}_{}_{}_independent_wb_rate".format(
    ...
    middleshape = 4096
    outshape = 10
    MODEL.classifier[0] = Independent_Linear(in_shape, middleshape, True, per)
    MODEL.classifier[3] = Independent_Linear(
