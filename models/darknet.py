...
def _make_layers(in_channels, out_channels, block_num):
    _layers = [Conv3x3BNReLU(in_channels=in_channels, out_channels=out_channels, stride=2)]
...
class Darknet53(nn.Module):
    def __init__(self, num_classes=1000):
        ...
        self.block1 = _make_layers(in_channels=32, out_channels=64, block_num=1)
        self.block2 = _make_layers(in_channels=64, out_channels=128, block_num=2)
        self.block3 = _make_layers(in_channels=128, out_channels=256, block_num=8)
        self.block4 = _make_layers(in_channels=256, out_channels=512, block_num=8)
        self.block5 = _make_layers(in_channels=512, out_channels=1024, block_num=4)
