...
from functions import GroupLinearFunction, SequentialLinearFunction
...
class SemisyncLinear(Linear, Rotatable):
    ...
    def forward(self, input_tensor) -> Tensor:
        ...
        matmul = GroupLinearFunction.apply
...
class SequentialLinear(Linear, Rotatable):
    ...
    def forward(self, input_tensor) -> Tensor:
        matmul = SequentialLinearFunction.apply
